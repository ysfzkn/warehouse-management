...
export default function AdminContactMessages() {
  ...
  const fetchItems = useCallback(() => {
    ...
    axios
      .get('/api/admin/contact-messages', { params })
      .then((r) => {
      ...
      <div className="row g-3 mb-4">
        {Object.entries(STATUS_MAP).map(([key, s]) => (
          <div key={key} className="col-12 col-md-4">
            <div
              className={`card border-0 shadow-sm h-100 ${statusFilter === key ? 'border-start border-4 border-' + s.color : ''}`}
            ...
            >
              <div className="card-body py-3 d-flex align-items-center gap-3">
                <div
                  className={`bg-${s.color} bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center`}
                    ...
                    return (
                      ...
                      >
                        <div className="d-flex justify-content-between align-items-start">
                          ...
                          <span className={`badge bg-${s.color} ms-2 flex-shrink-0`} style={{ fontSize: 10 }}>
                            {s.label}
                          </span>
                        </div>
                    ...
                    {selected.phone && (
                      <>
                        ...
                        <a href={`tel:${selected.phone}`}>
                          <i className="fas fa-phone me-1" style={{ fontSize: 10 }} />
                          {selected.phone}
                        </a>
                      </>
                    )}
