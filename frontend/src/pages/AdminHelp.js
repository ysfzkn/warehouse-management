...
const SECTIONS = [
  {
    ...
    items: [
      {
        q: 'Admin panele nasıl giriş yaparım?',
        a: 'Tarayıcınızda sitenizin admin adresine gidin (örn: siteniz.com/login). Size verilen kullanıcı adı ve şifreyi girin. İlk girişten sonra şifrenizi değiştirmeniz önerilir.',
      },
      {
        q: 'Güvenlik kodu nedir?',
        a: 'Silme, ödeme onaylama, gateway ekleme gibi kritik işlemlerde sizden ek bir güvenlik kodu istenir. Bu kod, yetkisiz erişimi önlemek için kullanılır. Güvenlik kodunuzu "Ayarlar → Yönetici Ayarları" bölümünden değiştirebilirsiniz.',
      },
      {
        q: 'Admin panelin genel yapısı nasıl?',
        a: 'Üst menüde 5 ana bölüm bulunur:\n\n• Envanter — Ürünler, kategoriler, markalar, renkler\n• Depolar — Depo yönetimi\n• Stok Yönetimi — Stok takibi ve düşük stok uyarıları\n• E-Ticaret — Siparişler, ödemeler, müşteriler, destek talepleri\n• Ayarlar — Ödeme, kargo, site ayarları, CMS',
      },
      {
        q: 'Stok uyarı rozeti ne anlama geliyor?',
        a: '"Stok Yönetimi" menüsündeki kırmızı rakam, minimum stok seviyesinin altına düşmüş ürün sayısını gösterir. Bu ürünleri stok yönetimi sayfasından görebilir ve stok ekleyebilirsiniz.',
      },
    ],
  },
  {
    ...
    items: [
      {
        q: 'Yeni ürün nasıl eklerim?',
        a: '1. Üst menüden "Envanter → Ürünler" sayfasına gidin\n2. "Yeni Ürün" butonuna tıklayın\n3. Ürün adı, SKU (stok kodu), fiyat bilgilerini girin\n4. Kategori, marka ve renk seçin\n5. Fotoğraf yükleyin (birden fazla yükleyebilirsiniz)\n6. "Kaydet" butonuna tıklayın',
      },
      {
        q: 'Ürün fotoğrafı nasıl yüklerim?',
        a: 'Ürün düzenleme formunun alt kısmında "Görseller" bölümü bulunur. "Dosya seçin" alanına tıklayarak veya dosyaları sürükleyerek fotoğraf yükleyebilirsiniz. PNG, JPG ve WebP formatları desteklenir. Birden fazla fotoğraf yükleyebilirsiniz.',
      },
      {
        q: 'İndirim/kampanya nasıl oluştururum?',
        a: 'Ürün düzenleme formunda:\n• İndirimli Fiyat alanına indirimli tutarı girin\n• Yüzde hesaplama otomatik yapılır\n• İsteğe bağlı: Başlangıç ve bitiş tarihi belirleyin\n\nToplu indirim için: "Kuponlar" sayfasından indirim kuponu oluşturabilirsiniz (yüzde, sabit tutar veya ücretsiz kargo).',
      },
      {
        q: 'SEO ayarları nedir, nasıl düzenlerim?',
        a: 'Ürün formunun alt kısmındaki "SEO Ayarları" bölümünü açın:\n• Meta Başlık — Google arama sonuçlarında görünen başlık (max 200 karakter)\n• Meta Açıklama — Arama sonuçlarındaki açıklama metni (max 500 karakter)\n• Slug — URL\'deki ürün adı (otomatik oluşturulabilir)\n\nBu alanları doldurmanız Google sıralamanızı iyileştirir.',
      },
      {
        q: 'Kategori nasıl eklerim?',
        a: '"Envanter → Kategoriler" sayfasından yeni kategori ekleyebilirsiniz. Alt kategori oluşturmak için önce ana kategoriyi seçin, ardından "Alt Kategori Ekle" butonunu kullanın.',
      },
      {
        q: '"Öne Çıkan" ve "Yeni Ürün" etiketleri ne işe yarar?',
        a: 'Ürün formundaki bu checkbox\'lar:\n• Öne Çıkan — Ana sayfada "Öne Çıkan Ürünler" bölümünde gösterilir\n• Yeni Ürün — Ürün kartında "Yeni" rozeti gösterilir\n\nHer iki etiket de müşterilerin dikkatini çekmek için kullanılır.',
      },
      {
        q: 'Toplu fiyat güncelleme nasıl yaparım?',
        a: '"Ürünler" sayfasında birden fazla ürünü seçin, ardından "Toplu İşlemler" butonundan "Fiyat Güncelle" seçeneğini kullanın. Yüzde artış/azalış veya sabit tutar ekleyebilirsiniz.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: 'Ödeme yöntemlerini nasıl açıp kapatabilirim?',
        a: '"Ayarlar → Ödeme Ayarları" sayfasının üst kısmında 3 toggle bulunur:\n• Kredi Kartı ile Ödeme\n• Havale / EFT ile Ödeme\n• Kapıda Ödeme\n\nToggle\'ı kapatırsanız o yöntem müşterilere gösterilmez.',
      },
      {
        q: 'iyzico gateway nasıl eklerim?',
        a: '1. "Ödeme Ayarları" sayfasında "Yeni Gateway Ekle" butonuna tıklayın\n2. Protokol: "iyzico" seçin\n3. Kod: "IYZICO_1" yazın\n4. API Key ve Secret Key: iyzico panelinden alın\n5. Base URL: sandbox için "https://sandbox-api.iyzipay.com"\n6. Callback URL: "https://siteniz.com/api/store/payment/callback"\n7. Ortam: Test için "Sandbox", canlı için "Production"\n8. Güvenlik kodu girip "Oluştur"a tıklayın\n9. Gateway\'i aktifleştirin ve varsayılan yapın',
      },
      {
        q: 'iyzico sandbox test nasıl yaparım?',
        a: "1. sandbox-merchant.iyzipay.com adresinden hesap oluşturun\n2. API anahtarlarını alıp gateway'e girin\n3. Sandbox modunda test kartlarıyla deneme yapın:\n   • Kart No: 5528790000000008\n   • SKT: 12/2030\n   • CVV: 123\n   • 3D SMS kodu: 123456\n4. Gerçek para çekilmez",
      },
      {
        q: 'Havale bilgilerini nasıl ayarlarım?',
        a: '"Ödeme Ayarları" sayfasında "Havale / EFT Bilgileri" bölümünden:\n• Banka adı\n• IBAN numarası\n• Hesap sahibi adı\n• Ödeme süresi (saat)\ndeğerlerini girin ve "Kaydet"e tıklayın.',
      },
      {
        q: '"Test" butonu ne işe yarar?',
        a: 'Gateway listesindeki "Test" (fiş ikonu) butonu, girdiğiniz API anahtarlarının geçerli olup olmadığını kontrol eder. Gerçek ödeme yapmaz, sadece bağlantı doğrulaması yapar.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Kargo firmasının gönderi sorgulama sayfası URL'sidir. {trackingNo} kısmı otomatik olarak takip numarasıyla değiştirilir.\n\nÖrnek: https://www.yurticikargo.com/tr/online-servisler/gonderi-sorgula?code={trackingNo}",
      },
    ],
  },
  {
    ...
    icon: FiUsers,
    color: '#d97706',
    title: 'Müşteri ve Destek',
    items: [
      {
        q: 'Müşteri listesini nasıl görüntülerim?',
        a: '"E-Ticaret → Müşteriler" sayfasında tüm kayıtlı müşterileri görebilirsiniz. Ad, e-posta, telefon ve kayıt tarihine göre arama yapabilirsiniz.',
      },
      {
        q: 'Destek taleplerini nasıl yanıtlarım?',
        a: '1. "E-Ticaret → Destek Talepleri" sayfasına gidin\n2. Listeden talebi seçin (sol panel)\n3. Sağ panelde müşterinin mesajını okuyun\n4. Yanıtınızı yazın ve "Yanıtla" butonuna tıklayın\n5. Durumu güncelleyin (İşlemde → Yanıtlandı → Kapatıldı)\n\nMüşteri yanıtınızı "Destek Taleplerim" sayfasından görebilir.',
      },
      {
        q: 'Müşteri hesabını nasıl deaktif ederim?',
        a: '"Müşteriler" sayfasında müşteri detayını açın, "Durum Değiştir" butonuyla hesabı pasif hale getirebilirsiniz. Pasif hesaplar giriş yapamaz.',
      },
    ],
  },
  {
    ...
    icon: FiSettings,
    color: '#059669',
    title: 'İçerik ve Site Ayarları',
    items: [
      {
        q: 'Logo nasıl değiştiririm?',
        a: '"Ayarlar → Site Ayarları → Marka & Görünüm" bölümünden:\n1. Mevcut logo önizlemesinin altındaki "Değiştir" butonuna tıklayın\n2. Yeni logo dosyasını seçin (PNG, SVG, WebP)\n3. Güvenlik kodunuzu girin\n4. Logo otomatik güncellenir',
      },
      {
        q: 'Banner nasıl eklerim?',
        a: '"Ayarlar → İçerik Yönetimi" sayfasından "Banner" tipinde yeni içerik ekleyebilirsiniz:\n• Görsel yükleyin\n• Link atayın (kategori, ürün veya dış URL)\n• Sıralama numarası verin\n\nBannerlar ana sayfada slayt gösterisi olarak görünür.',
      },
      {
        q: 'Duyuru çubuğu nasıl düzenlerim?',
        a: '"Site Ayarları → Genel" bölümünde "Üst Banner Duyuru Mesajı" alanına istediğiniz metni yazın. Bu metin sitenin en üstünde sabit bir çubukta gösterilir. Boş bırakırsanız çubuk gizlenir.',
      },
      {
        q: 'Site renklerini nasıl değiştiririm?',
        a: '"Site Ayarları → Marka & Görünüm" bölümünde:\n• Ana Renk — Butonlar, linkler ve vurgularda kullanılır\n• İkincil Renk — İkincil butonlar ve arka plan tonlarında\n\nRenk seçiciden istediğiniz rengi seçin veya HEX kodunu girin (#2563eb gibi).',
      },
      {
        q: 'Sabit sayfa nasıl oluştururum? (Hakkımızda, SSS vb.)',
        a: '"İçerik Yönetimi" sayfasından "Sayfa" tipinde yeni içerik ekleyebilirsiniz. Slug alanına URL\'de görünecek adı yazın (ör: hakkimizda). İçerik HTML editörüyle düzenlenebilir.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: 'Ürün fotoğrafları mağazada görünmüyor',
      ...
      {
        q: 'Müşteri kayıt olmuyor veya giriş yapamıyor',
      ...
      {
        q: 'Sipariş durumu güncellenmiyor',
        a: 'Sipariş durum geçişleri belirli kurallara tabidir:\n• Ödeme Bekliyor → sadece Ödendi, Hazırlanıyor veya İptal\n• Ödendi → Hazırlanıyor veya İptal\n• Hazırlanıyor → Kargoda veya İptal\n• Kargoda → Teslim Edildi veya İade Talebi\n\nİzin verilmeyen geçişlerde hata alırsınız.',
      },
      {
        q: 'Excel export çalışmıyor',
        a: '"Excel İndir" butonuna tıkladığınızda dosya inmiyor veya hata alıyorsanız:\n1. Tarayıcınızın pop-up engelleyicisini kontrol edin\n2. Admin oturumunuzun açık olduğundan emin olun\n3. Sayfa yenileyip tekrar deneyin',
      },
      {
        q: 'Kargo takip linki çalışmıyor',
        a: 'Kargo Ayarları sayfasında ilgili firmanın "Takip URL Şablonu" alanını kontrol edin. URL\'de {trackingNo} kısmının olduğundan emin olun. Bazı kargo firmaları URL formatını değiştirebilir.',
      },
      {
        q: 'Site yavaş yükleniyor',
  ...
  return (
    ...
    >
      <div
        ...
        style={{ cursor: 'pointer', borderLeft: `4px solid ${section.color}` }}
      ...
      >
        ...
        >
          {open ? (
            <FiChevronUp size={14} className="text-muted" />
          ) : (
  ...
  return (
    <div
      style={{
        borderRadius: 12,
        overflow: 'hidden',
        border: open ? '1px solid #dbeafe' : '1px solid #e8ecf1',
        transition: 'all 0.2s',
        boxShadow: open ? '0 2px 12px rgba(37,99,235,0.08)' : 'none',
      }}
    >
      <div
        ...
        onMouseLeave={(e) => {
          if (!open) e.currentTarget.style.background = '#fafbfc';
        }}
      >
        <FiHelpCircle size={14} style={{ color: open ? '#2563eb' : '#94a3b8' }} className="flex-shrink-0" />
        <span className="small fw-medium flex-grow-1" style={{ color: open ? '#1e40af' : '#334155' }}>
          {item.q}
        </span>
        <div
          style={{
        ...
        >
          {open ? (
            <FiChevronUp size={12} style={{ color: '#2563eb' }} />
          ) : (
      ...
      {open && (
        <div className="px-3 pb-3 pt-2" style={{ background: '#fff', borderTop: '1px solid #eff6ff' }}>
          <div className="small" style={{ whiteSpace: 'pre-line', lineHeight: 1.8, color: '#475569' }}>
            {item.a}
          </div>
        </div>
      )}
...
export default function AdminHelp() {
  ...
  // Sayfa navbar'ın ALTINDA yaşadığından minHeight:100vh dokümanı navbar
  // kadar taşırıp kalıcı boşluk/scroll yaratıyordu. Kalan yüksekliği dinamik
  // ölç: navbar yüksekliğini çıkar + eleman kendi üst offset'ini (breakout
  // margin dahil) hesaba kat. Resize/density değişiminde yeniden hesaplanır.
  const [minHeight, setMinHeight] = useState('100dvh');
  useEffect(() => {
    const compute = () => {
      const el = rootRef.current;
      // Elemanın viewport üstünden başladığı nokta (scroll'dan bağımsız).
      const topOffset = el ? el.getBoundingClientRect().top + window.scrollY : 0;
      setMinHeight(`calc(100dvh - ${Math.max(0, Math.round(topOffset))}px)`);
    };
    compute();
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        {/* Hero Header */}
        <div
          className="text-center mb-5 py-4 px-3 rounded-4"
          style={{
        ...
        >
          ...
          <p className="mb-0" style={{ color: 'rgba(255,255,255,0.7)', fontSize: 14 }}>
            Admin panel kullanım kılavuzu — {totalQuestions} konu
          </p>
        </div>
        ...
        <div className="mb-4" style={{ marginTop: -28, position: 'relative', zIndex: 1 }}>
          <div className="mx-auto" style={{ maxWidth: 640 }}>
            ...
            >
              ...
              <input
                ...
                placeholder="Ne yapmak istiyorsunuz? Arayın..."
                value={search}
          ...
          {search && (
            <small className="text-muted d-block mt-2 text-center">{matchCount} sonuç bulundu</small>
          )}
        </div>
        ...
        {search && matchCount === 0 && (
          ...
          >
            ...
            <button className="btn btn-sm btn-outline-primary" onClick={() => setSearch('')}>
              Aramayı Temizle
            </button>
          </div>
        )}
        ...
        {/* Footer */}
        <div
          className="text-center py-4 mt-4 rounded-4"
