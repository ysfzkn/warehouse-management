...
export default function ProductDetailPage() {
  ...
  const breadcrumbSchema = buildBreadcrumbSchema(
    [
      { name: 'Ana Sayfa', url: '/' },
      ...(product.categorySlug
        ? [{ name: product.categoryName, url: `/kategori/${product.categorySlug}` }]
        : []),
    ...
    <div className="container my-3">
      ...
      >
        ...
        <meta
          ...
          content={String(hasDiscount ? product.salePrice : product.price)}
        />
        ...
        <meta
          ...
          content={product.stockStatus === 'OUT_OF_STOCK' ? 'out of stock' : 'in stock'}
        />
      </SeoHead>
        ...
        <div className="col-lg-6">
          ...
          <div className="d-flex gap-3 text-muted small mb-3">
            ...
            {product.categoryName && (
              <span>
                Kategori:{' '}
                <Link to={`/kategori/${product.categorySlug}`} className="text-primary">
                  {product.categoryName}
                </Link>
              </span>
            )}
          ...
          >
            ...
            {notifySubmitted ? (
              <div className="text-center py-3">
                ...
                <h6 className="fw-bold mb-2" style={{ color: '#059669' }}>
                  Aboneliğiniz Alındı!
                </h6>
                <p className="text-muted small mb-3">
                  Bu ürün stoklarımıza geri geldiğinde <strong>{notifyEmail}</strong> adresinize e-posta
                  göndereceğiz.
                </p>
              ...
              >
                <p className="text-muted small mb-3">
                  E-posta adresinizi girin, ürün stoklarımıza geri geldiği anda size bildireceğiz. İstediğiniz
                ...
                <div className="d-flex gap-2">
                  ...
                  <button type="submit" className="btn btn-warning flex-grow-1" disabled={notifyLoading}>
                    {notifyLoading ? (
                      <>
      ...
      {product.stockStatus !== 'OUT_OF_STOCK' && (
        <div className="store-pdp-sticky-cta d-md-none" role="region" aria-label="Hızlı satın alma">
          <div className="store-pdp-sticky-price">
            <small className="text-muted d-block" style={{ fontSize: 11, lineHeight: 1 }}>
              Fiyat
            </small>
