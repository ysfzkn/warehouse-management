...
export default function StoreLoginPage() {
  ...
  const handleGoogleLogin = () => {
    if (!startGoogleAuth()) {
      toast.warning('Google ile giriş şu an kullanılamıyor.');
    }
  };
    ...
    <div className="container py-5" style={{ maxWidth: 460 }}>
      <div className="card border-0 shadow-lg overflow-hidden">
        ...
        <div className="card-body p-4">
          {/* Google Login — hidden entirely on a build with no client id, rather than
              offering a button that can only apologise for itself. */}
          {isGoogleAuthEnabled() && (
            <>
              <button
                type="button"
          ...
          <div className="text-center mt-4 pt-3 border-top">
            ...
            <Link to="/kayit" className="fw-semibold small">
              Üye Olun
            </Link>
          </div>
        </div>
