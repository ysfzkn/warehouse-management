...
const SETTING_GROUPS = [
  {
    id: 'storestatus',
    section: 'Mağaza',
    title: 'Satış Durumu (Test Modu)',
    icon: 'fas fa-store-alt-slash',
    keys: ['store_purchasing_enabled', 'store_test_mode_banner'],
    tooltip:
      'Mağazanın satışa açık olup olmadığını kontrol eder. Test/bakım aşamasında kapatın — site görünür kalır ama sipariş alınmaz.',
  },
  {
    id: 'brand',
    section: 'Mağaza',
    title: 'Marka & Görünüm',
    icon: 'fas fa-palette',
    keys: ['site_name', 'site_logo_url', 'site_favicon_url', 'primary_color', 'secondary_color'],
  ...
  },
  {
    id: 'notices',
    section: 'Mağaza',
    title: 'Beyaz Eşya Uyarıları',
    icon: 'fas fa-exclamation-triangle',
    keys: ['warranty_notice_text', 'bulky_shipping_notice_text'],
  ...
  },
  {
    ...
    title: 'Genel',
    icon: 'fas fa-cog',
    keys: ['footer_text', 'header_announcement', 'contact_form_email'],
    tooltip: 'Footer alt bilgisi, üst bar duyuru mesajı ve form yönlendirme.',
  },
  {
    id: 'shipping',
    section: 'Mağaza',
    title: 'Kargo Ücretlendirme',
  ...
  },
  {
    ...
    keys: ['abandoned_cart_enabled', 'abandoned_cart_delay_hours', 'abandoned_cart_reminder_window_hours'],
  ...
  },
  {
    ...
    keys: [
      ...
      'seo_geo_lat',
      'seo_geo_lng',
      'seo_local_business_type',
      'seo_local_price_range',
      'seo_local_opening_hours',
      'seo_local_founding_year',
      'seo_local_slogan',
      'seo_brand_aliases',
      'seo_local_primary_brands',
      'seo_local_primary_categories',
      'seo_local_description',
      'seo_local_keywords_extra',
    ],
    tooltip:
      'Konum bazlı SEO: "Niğde Profilo", "Niğde çamaşır makinesi" gibi aramalarda öne çıkmak için. Şehri + öne çıkan marka/kategorileri girin; site LocalBusiness yapısal verisi + otomatik anahtar kelime kombinasyonları üretir.',
  },
  {
    id: 'sms',
    ...
    icon: 'fas fa-sms',
    keys: ['sms_enabled', 'sms_provider', 'netgsm_username', 'netgsm_password', 'netgsm_sender'],
  ...
  },
  {
    ...
    keys: [
      ...
      'kargonomi_api_token',
      'kargonomi_app_key',
      'kargonomi_api_base_url',
      'kargonomi_webhook_secret',
      'kargonomi_warehouse_id',
    ],
    tooltip:
      'Kargo gönderi oluşturma ve takip API entegrasyonu. Aktif edince sipariş SHIPPED olunca otomatik kargo oluşturulur.',
  ...
  },
  {
    ...
    keys: [
      ...
      'logo_efatura_endpoint',
      'logo_efatura_username',
      'logo_efatura_password',
      'logo_efatura_test_mode',
      'logo_customer_alias',
      'logo_earsiv_design_file',
      'logo_efatura_design_file',
      'invoice_admin_digest_email',
    ],
    tooltip:
      'Logo eLogo SOAP API ile e-Fatura / e-Arşiv entegrasyonu. Sipariş PAID olunca otomatik fatura oluşturulur.',
  ...
  },
  {
    ...
    keys: [
      'logo_company_vkn',
      'logo_company_title',
      'logo_company_tax_office',
      'logo_company_mersis_no',
      'logo_company_trade_registry',
      'logo_company_address',
      'logo_company_city',
      'logo_company_district',
      'logo_company_postal_code',
      'logo_company_email',
      'logo_company_phone',
      'logo_company_website',
      'logo_company_bank_name',
      'logo_company_bank_iban',
    ],
...
const LABELS = {
  ...
  chamber_of_commerce: 'Ticaret/Sanayi Odası',
  etbis_qr_url: 'ETBİS QR Kod URL',
  warranty_notice_text: 'Garanti Uyarı Metni',
  bulky_shipping_notice_text: 'Hacimli Ürün Kargo Uyarısı',
  footer_text: 'Alt Bilgi Metni',
  currency_symbol: 'Para Birimi',
  store_purchasing_enabled: 'Satışa Açık',
  store_test_mode_banner: 'Test Modu Banner Metni',
  free_shipping_threshold: 'Ücretsiz Kargo Limiti (TL)',
  default_shipping_cost: 'Varsayılan Kargo Ücreti (TL)',
  header_announcement: 'Üst Banner Duyuru Mesajı',
  contact_form_email: 'İletişim Formu Hedef E-posta',
  payment_method_credit_card_enabled: 'Kredi Kartı ile Ödeme',
  payment_method_bank_transfer_enabled: 'Havale / EFT ile Ödeme',
  payment_method_door_cash_enabled: 'Kapıda Ödeme',
  abandoned_cart_enabled: 'Terk Edilmiş Sepet E-postası',
  abandoned_cart_delay_hours: 'Bekleme Süresi (saat)',
  abandoned_cart_reminder_window_hours: 'Hatırlatma Penceresi (saat)',
  sms_enabled: 'SMS Gönderimi',
  sms_provider: 'SMS Sağlayıcı',
  netgsm_username: 'Netgsm Kullanıcı Adı',
  netgsm_password: 'Netgsm Şifre',
  netgsm_sender: 'Netgsm Gönderici Başlık',
  seo_canonical_domain: 'Canonical Domain',
  seo_organization_name: 'Kuruluş Adı',
  seo_default_meta_description: 'Varsayılan Meta Açıklama',
  seo_default_og_image: 'Varsayılan Paylaşım Görseli (OG Image)',
  seo_twitter_handle: 'Twitter / X Hesabı',
  seo_local_city: 'Şehir (Konum)',
  seo_local_region: 'İl / Bölge',
  seo_local_postal_code: 'Posta Kodu',
  seo_geo_lat: 'Enlem (Latitude)',
  seo_geo_lng: 'Boylam (Longitude)',
  seo_local_business_type: 'İşletme Türü (Schema)',
  seo_local_price_range: 'Fiyat Aralığı (₺₺)',
  seo_local_opening_hours: 'Çalışma Saatleri',
  seo_local_primary_brands: 'Öne Çıkan Markalar',
  seo_local_primary_categories: 'Öne Çıkan Kategoriler',
  seo_local_keywords_extra: 'Ek Anahtar Kelimeler',
  seo_local_founding_year: 'Kuruluş Yılı',
  seo_local_slogan: 'Slogan',
  seo_brand_aliases: 'Marka Adı Varyasyonları',
  seo_local_description: 'İşletme Açıklaması (GEO)',
  analytics_google_id: 'Google Analytics 4 ID',
  analytics_facebook_pixel_id: 'Facebook Pixel ID',
  analytics_hotjar_id: 'Hotjar Site ID',
  analytics_clarity_id: 'Microsoft Clarity Project ID',
  cargo_api_enabled: 'Kargo API Entegrasyonu',
  cargo_api_provider: 'Kargo API Sağlayıcı',
  cargo_api_auto_create: 'Otomatik Kargo Oluştur',
  kargonomi_api_token: 'Kargonomi API Token (Bearer)',
  kargonomi_app_key: 'Kargonomi APP KEY',
  kargonomi_api_base_url: 'Kargonomi API URL',
  ...
  sender_district: 'Gönderici İlçe',
  sender_postal_code: 'Gönderici Posta Kodu',
  invoice_provider: 'E-Fatura Sağlayıcı',
  invoice_auto_generate: 'Otomatik Fatura Oluştur',
  logo_efatura_endpoint: 'Logo SOAP Endpoint URL',
  logo_efatura_username: 'Logo Kullanıcı Adı',
  logo_efatura_password: 'Logo Şifre',
  logo_efatura_test_mode: 'Test Modu',
  ...
  logo_company_tax_office: 'Vergi Dairesi',
  logo_company_mersis_no: 'MERSİS No',
  logo_company_trade_registry: 'Ticaret Sicil No',
  logo_company_address: 'Firma Adresi',
  logo_company_city: 'Şehir',
  logo_company_district: 'İlçe',
  logo_company_postal_code: 'Posta Kodu',
  logo_company_email: 'Firma E-posta',
  logo_company_phone: 'Firma Telefon',
  logo_company_website: 'Web Sitesi',
  logo_company_bank_name: 'Banka Adı',
  logo_company_bank_iban: 'IBAN',
};
...
const FIELD_TOOLTIPS = {
  ...
  store_purchasing_enabled:
    'AÇIK = müşteriler sipariş verebilir (canlı satış). KAPALI = test/bakım modu: site açık kalır, ürünler görünür ama "Sepete Ekle/Sipariş" engellenir ve üstte test banner gösterilir. Yeni sürüm testinde veya bakımda kapatın.',
  store_test_mode_banner:
    'Test modunda (satış kapalıyken) sitenin üstünde gösterilecek uyarı metni. Boş bırakılırsa varsayılan metin kullanılır.',
  ...
  payment_method_bank_transfer_enabled:
    'Kapatırsanız havale/EFT seçeneği gösterilmez. IBAN yapılandırılmamışsa otomatik gizlenir.',
  payment_method_door_cash_enabled: 'Kapatırsanız kapıda ödeme seçeneği gösterilmez',
  abandoned_cart_enabled:
    'Kapattığınızda terk edilmiş sepetler için hatırlatma e-postası gönderilmez. Sadece marketing onayı olan müşterilere gönderilir.',
  abandoned_cart_delay_hours: 'Sepet son güncellendikten kaç saat sonra hatırlatma gönderilsin (önerilen: 2)',
  abandoned_cart_reminder_window_hours:
    'Bu süreden eski sepetlere hatırlatma gönderilmez (önerilen: 72 saat)',
  sms_enabled:
    'Sipariş onay, kargo bilgileri gibi bildirimler SMS olarak da gönderilir. Aktif etmek için bir SMS sağlayıcısı seçin ve bilgilerini girin.',
  ...
  seo_canonical_domain:
    "Canonical URL'lerde kullanılacak ana domain (örn: https://magazam.com). Boşsa istek geldiği domain kullanılır.",
  seo_organization_name: 'Schema.org Organization ismi. Boşsa site adı kullanılır.',
  seo_local_city:
    'Mağazanın bulunduğu şehir (örn: Niğde). Title ve anahtar kelimelere otomatik eklenir: "Niğde Profilo Çamaşır Makinesi". Yerel SEO\'nun temel alanı.',
  seo_local_region: 'İl/bölge adı (örn: Niğde). Boşsa şehir kullanılır.',
  seo_geo_lat:
    "Mağaza konumu enlem. Google Haritalar'da mağazana sağ tıkla → çıkan ilk sayı enlem (örn: 37.9667). Boşsa geo verisi eklenmez.",
  seo_geo_lng: "Mağaza konumu boylam. Google Haritalar'daki ikinci sayı (örn: 34.6833).",
  seo_local_business_type:
    'Schema.org işletme türü. Beyaz eşya için "HomeGoodsStore" önerilir. Diğer: "ElectronicsStore", "Store".',
  seo_local_price_range: 'Fiyat aralığı sembolü, örn: ₺₺ veya ₺₺₺ (Google yerel kartında görünür).',
  seo_local_opening_hours: 'Çalışma saatleri (Schema formatı), örn: "Mo-Sa 09:00-19:00". Boş bırakılabilir.',
  seo_local_primary_brands:
    'Öne çıkmak istediğin markalar, virgülle: "Profilo". Şehirle çarpılıp anahtar kelime üretir: "Niğde Profilo".',
  seo_local_primary_categories:
    'Öne çıkan kategoriler, virgülle: "Çamaşır Makinesi, Buzdolabı, Bulaşık Makinesi". "Niğde çamaşır makinesi", "Niğde Profilo çamaşır makinesi" üretir.',
  seo_local_keywords_extra: 'Ek anahtar kelimeler, virgülle (otomatik üretilenlere eklenir).',
  seo_local_founding_year:
    'Kuruluş yılı (örn: 1980). Yapısal veriye foundingDate olarak eklenir, AI/Google işletme geçmişini gösterir.',
  seo_local_slogan:
    'Kısa slogan (örn: "1980\'den beri güvenilir beyaz eşya"). Schema slogan alanına eklenir.',
  seo_brand_aliases:
    'İşletme adı varyasyonları, virgülle: "ATS DTM, ATSDTM, ATS DTM E-Ticaret". Direkt marka aramasında ("ats dtm") öne çıkmak için.',
  seo_local_description:
    "İşletmeyi tanıtan açıklama (markalar, kuruluş yılı, şehir). LocalBusiness description olarak AI/LLM'lere verilir — GEO için kritik.",
  seo_default_meta_description:
    'Özel açıklaması olmayan sayfalarda kullanılacak varsayılan meta açıklaması (150-160 karakter)',
  ...
  cargo_api_enabled:
    'Kapattığınızda manuel kargo takip kodu girişi ile devam eder. Aktifse sipariş SHIPPED olunca otomatik kargo oluşturulur.',
  ...
  kargonomi_webhook_secret:
    "Kargonomi webhook POST'larının HMAC-SHA256 imzasını doğrulamak için paylaşılan secret. Kargonomi panelinde webhook oluştururken aynı değeri girin.",
  kargonomi_warehouse_id:
  ...
  logo_efatura_endpoint:
    "Logo eLogo SOAP servis URL'i. Boş bırakırsanız test/prod moduna göre default kullanılır (pb-demo.elogo.com.tr veya pb.elogo.com.tr).",
  logo_efatura_username: 'Logo eLogo kullanıcı adınız',
  logo_efatura_password: 'Logo eLogo API şifreniz',
  logo_efatura_test_mode:
    'Açık: https://pb-demo.elogo.com.tr/PostboxService.svc kullanılır. Kapalı: production endpoint (pb.elogo.com.tr).',
  logo_customer_alias:
    "Tüzel müşterilerin e-Fatura alias'ı (opsiyonel). Boş bırakılırsa Logo panelindeki varsayılan kullanılır.",
  logo_earsiv_design_file:
    'e-Arşiv tasarım dosyası adı (Logo panelinden alınır, bireysel müşteri faturalarında kullanılır)',
  logo_efatura_design_file:
...
const validateField = (key, value) => {
  ...
  if (key === 'logo_company_vkn') {
    ...
    if (v.length !== 10 && v.length !== 11)
      return { type: 'warning', msg: 'VKN 10, TC Kimlik No 11 haneli olmalı' };
  }
  ...
  if (key === 'logo_company_bank_iban') {
    ...
    if (!/^TR\d{24}$/.test(ibanClean))
      return { type: 'warning', msg: 'Geçerli TR IBAN formatı: TR + 24 rakam' };
  }
...
export default function AdminSiteSettings() {
  ...
  const handleSave = useCallback(
    () =>
      withSecurityCode('Site ayarlarını kaydetmek için güvenlik şifresini girin.', async (code) => {
        setSaving(true);
        try {
  ...
  const handleFileUpload = async (type, file) => {
    ...
    const code = await askCode({
      description: `${isLogo ? 'Logo' : 'Favicon'} yüklemek için güvenlik şifresini girin.`,
    });
    if (!code) return;
        ...
        <div className="border rounded overflow-hidden">
          {hasFile && (
            <div className="d-flex align-items-center gap-3 p-3 bg-light border-bottom">
              <div
                className={`bg-white border rounded d-flex align-items-center justify-content-center ${isLogo ? 'p-2' : 'p-1'}`}
                style={isLogo ? { minWidth: 80, minHeight: 48 } : { width: 44, height: 44 }}
              >
                <img
                  src={currentUrl.startsWith('/') ? currentUrl + '?t=' + Date.now() : currentUrl}
                  alt={label}
                  style={isLogo ? { maxHeight: 40, maxWidth: 100 } : { width: 28, height: 28 }}
                  onError={(e) => {
  ...
  const renderField = (key) => {
    ...
    if (key === 'cargo_api_provider')
      return renderSelect(
        key,
        [
          { v: 'MOCK', l: 'Mock (Test / Geliştirme)' },
          { v: 'KARGONOMI', l: 'Kargonomi (multi-carrier)' },
        ],
        'MOCK',
        isDirtyField,
        validation
      );
    if (key === 'invoice_provider')
      return renderSelect(
        key,
        [
          { v: 'MOCK', l: 'Mock (Test / Geliştirme)' },
          { v: 'LOGO', l: 'Logo eLogo (e-Fatura / e-Arşiv)' },
        ],
        'MOCK',
        isDirtyField,
        validation
    ...
    if (key === 'currency_symbol')
      return renderSelect(
        key,
        CURRENCY_OPTIONS.map((c) => ({ v: c.value, l: c.label })),
        '₺',
        isDirtyField,
        validation
      );
    ...
    // Toggles
    if (
      (key.startsWith('payment_method_') && key.endsWith('_enabled')) ||
      [
        'store_purchasing_enabled',
        'abandoned_cart_enabled',
        'sms_enabled',
      ...
      return (
        <div key={key} className={colSize}>
          <div
            className={`border rounded p-3 h-100 d-flex align-items-start gap-3 ${isOn ? 'border-success bg-success bg-opacity-10' : ''}`}
          >
            ...
            <div className="flex-grow-1">
              <label
                className="form-check-label small fw-semibold d-block"
                htmlFor={key}
                style={{ cursor: 'pointer' }}
              >
                {LABELS[key]}
              ...
              {FIELD_TOOLTIPS[key] && (
                <small className="text-muted d-block mt-1">{FIELD_TOOLTIPS[key]}</small>
              )}
            </div>
          </div>
        </div>
    ...
    if (key === 'contact_map_embed') {
      return (
        <div key={key} className="col-12">
          ...
          />
          {settings[key] && (
            <div className="mt-2 border rounded overflow-hidden" style={{ height: 180 }}>
              <iframe
                src={settings[key]}
        ...
        <div key={key} className="col-12">
          ...
          <div className="d-flex justify-content-between align-items-center mt-1">
            ...
            <div className="progress" style={{ width: 120, height: 4 }}>
              <div
                className={`progress-bar ${len === 0 ? 'bg-secondary' : len < 120 ? 'bg-warning' : len <= 160 ? 'bg-success' : 'bg-danger'}`}
                style={{ width: `${Math.min(100, (len / 160) * 100)}%` }}
              ></div>
            </div>
          </div>
        </div>
      ...
      <div key={key} className={isShort ? 'col-md-6' : 'col-12'}>
        ...
        {validation && (
          <small className={`d-block mt-1 ${validation.type === 'warning' ? 'text-warning' : 'text-info'}`}>
            <i
              className={`fas ${validation.type === 'warning' ? 'fa-exclamation-circle' : 'fa-info-circle'} me-1`}
            ></i>
            {validation.msg}
          </small>
        )}
    ...
    <div>
      ...
      <div className="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div>
          <h2 className="mb-0 d-flex align-items-center gap-2">
            ...
            Site Ayarları
            {isDirty && (
              <span className="badge bg-warning text-dark ms-2" style={{ fontSize: 12 }}>
                <i className="fas fa-circle me-1" style={{ fontSize: 8 }}></i>
                {dirtyKeys.size} değişiklik
              </span>
            )}
          </h2>
          <p className="text-muted small mb-0">
            Mağaza görünümü, iletişim, ödeme ve entegrasyon yapılandırması
          </p>
        </div>
      ...
      {(() => {
        ...
        return (
          <div className="alert alert-danger d-flex align-items-start gap-2 mb-3" role="alert">
            ...
            <div className="flex-grow-1">
              <strong>Yasal uyumluluk eksikliği:</strong> Aşağıdaki alanlar Türkiye e-ticaret mevzuatı (6563
              sayılı kanun, ETBİS, KVKK) gereği zorunludur ve henüz doldurulmamıştır. Lansman öncesi mutlaka
              doldurun:
              <div className="mt-2">
                {missing.map((k) => (
                  <span key={k} className="badge bg-danger me-1 mb-1">
                    {LABEL_MAP[k] || k}
                  </span>
                ))}
              </div>
        ...
        <div className="card-body py-2 px-3">
          <div className="d-flex align-items-center justify-content-between mb-1">
            <span className="small">
              ...
              <strong>Genel Tamamlanma:</strong>{' '}
              <span className="text-primary fw-semibold">{totalStats.percent}%</span>
              <span className="text-muted ms-2">
                ({totalStats.filled}/{totalStats.total} alan doldu)
              </span>
            </span>
            <span className="small text-muted">
              {totalStats.percent >= 90
                ? '🎯 Çok iyi'
                : totalStats.percent >= 60
                  ? '👍 İyi gidiyor'
                  : '⚠️ Eksikler var'}
            </span>
          </div>
          <div className="progress" style={{ height: 6 }}>
            <div
              className={`progress-bar ${totalStats.percent >= 90 ? 'bg-success' : totalStats.percent >= 60 ? 'bg-primary' : 'bg-warning'}`}
              style={{ width: `${totalStats.percent}%`, transition: 'width .5s' }}
            ></div>
          </div>
        </div>
      </div>
        ...
        <div className="card-body py-2 px-3">
          <div className="input-group input-group-sm">
            ...
            <input
              ...
              placeholder="Ayar ara (örn: vergi, sms, renk, analytics)..."
              value={searchTerm}
      ...
      <div className="card border-0 shadow-sm mb-4">
        <div className="card-header bg-warning bg-opacity-10 d-flex align-items-center justify-content-between">
          <div>
            <strong>
              <i className="fas fa-gavel me-2"></i>Yasal Uyumluluk Durumu
            </strong>
            <span className="text-muted small ms-2 d-none d-md-inline">
              — Canlıya almadan önce tamamlayın
            </span>
          </div>
          {(() => {
            const checks = [
              !!settings.company_legal_name,
              !!settings.mersis_number,
              !!settings.kep_address,
              !!settings.tax_office && !!settings.tax_number,
              !!settings.etbis_qr_url,
            ];
            const done = checks.filter(Boolean).length;
            return (
              <span className={`badge bg-${done === checks.length ? 'success' : 'warning'} text-dark`}>
        ...
        <div className="card-body">
          <div className="row g-2">
            {[
              ...
              <div className="col-md-6" key={i}>
                <div
                  className={`d-flex align-items-center gap-2 p-2 rounded ${item.ok ? 'bg-success bg-opacity-10' : 'bg-danger bg-opacity-10'}`}
                >
                  <i
                    className={`fas ${item.ok ? 'fa-check-circle text-success' : 'fa-times-circle text-danger'}`}
                  ></i>
          ...
          <p className="text-muted small mb-0 mt-2">
            ...
            <strong> KVKK Aydınlatma</strong>, <strong>Çerez Politikası</strong>,{' '}
      ...
      {searchResults !== null ? (
        <div className="card border-0 shadow-sm">
          <div className="card-header bg-transparent">
            <strong>
              <i className="fas fa-search me-2"></i>Arama Sonuçları
            </strong>
            <span className="text-muted small ms-2">
              {searchResults.reduce((s, r) => s + r.matchedKeys.length, 0)} alan, {searchResults.length}{' '}
              grupta
            </span>
          </div>
          <div className="card-body">
        ...
        <div className="row g-4">
              ...
              <div className="card-body p-2">
                {Object.entries(sectionedGroups).map(([section, groups]) => (
                  <div key={section} className="mb-2">
                    <div
                      className="text-uppercase text-muted small fw-bold px-2 pt-2 pb-1"
                    ...
                    {groups.map((g) => {
                      ...
                      return (
                        ...
                        >
                          <i
                            className={g.icon}
                            style={{ width: 18, textAlign: 'center', opacity: isActive ? 1 : 0.6 }}
                          />
                          ...
                          {stats.dirty > 0 && (
                            <span
                              ...
                              style={{ fontSize: 9 }}
                              title={`${stats.dirty} değiştirildi`}
                            >
                              {stats.dirty}
                            </span>
                          )}
                          {hasEnabled && (
                            <span
                              className={`badge ${stats.enabled ? 'bg-success' : 'bg-secondary'} bg-opacity-75`}
                              style={{ fontSize: 9 }}
                              title={stats.enabled ? 'Aktif' : 'Pasif'}
                            >
                              <i
                                className={`fas fa-${stats.enabled ? 'check' : 'times'}`}
                                style={{ fontSize: 8 }}
                              ></i>
                            </span>
                          )}
          ...
          <div className="col-lg-9 col-md-8">
            <div className="card border-0 shadow-sm">
              <div
                className="card-header bg-transparent border-bottom d-flex flex-wrap justify-content-between align-items-center gap-2"
                  ...
                  <div>
                    ...
                    <div className="small text-muted">
                      ...
                      {activeGroup.enabledKey && (
                        <span
                          className={`badge ms-2 ${groupStats[activeGroup.id].enabled ? 'bg-success' : 'bg-secondary'}`}
                          style={{ fontSize: 9 }}
                        >
      ...
      {isDirty && (
        <div
          className="position-fixed bottom-0 start-0 end-0 bg-white border-top shadow-lg d-md-none"
          style={{ zIndex: 1020, padding: 12 }}
        >
          <div className="d-flex gap-2">
            <button
...
function FieldLabel({ label, tooltip, dirty }) {
  return (
    <div className="d-flex align-items-center gap-2 mb-1">
      ...
      {dirty && (
        <span className="badge bg-warning text-dark" style={{ fontSize: 9 }} title="Değiştirildi">
          <i className="fas fa-circle" style={{ fontSize: 6 }}></i>
        </span>
      )}
      {tooltip && (
        <span className="text-muted" title={tooltip} style={{ cursor: 'help', fontSize: 12 }}>
