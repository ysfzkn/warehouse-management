...
public class CezeriAdminTools {
    ...
    private static final Logger log = LoggerFactory.getLogger(CezeriAdminTools.class);
    ...
    public static class CezeriTransferListItem {
        public Long id;
    ...
    public PagedResponse<CezeriTransferListItem> searchTransfers(String status,
                                                                 String transferType,
                                                                 ...
                                                                 Integer page,
                                                                 Integer size) {
        log.debug("Cezeri tool searchTransfers filters: status={}, transferType={}, sourceWarehouseId={}, destinationWarehouseId={}, startDateRaw={}, endDateRaw={}, productName={}, sku={}, driverName={}, notes={}, customerQuery={}, page={}, size={}",
        ...
        // relax transferType to avoid false negatives (e.g., name may belong to driver/creator or transfer is WAREHOUSE).
        ...
        if (transfers.getTotalElements() == 0
            ...
            log.debug("Cezeri tool searchTransfers fallback: relaxed transferType filter (was {}). totalElements={}", filter.getTransferType(), transfers.getTotalElements());
            filter = relaxed;
        }
        List<CezeriTransferListItem> content = transfers.getContent().stream().map(CezeriAdminTools::toListItem).toList();
    ...
    public static CezeriTransferListItem toListItem(StockTransfer t) {
        CezeriTransferListItem out = new CezeriTransferListItem();
    ...
    public static LocalDateTime parseDateTimeLoose(String raw) {
        ...
        // Accept a few common formats to avoid tool-call failures.
        // 1) ISO: 2025-12-12T10:30:00
        try {
            return LocalDateTime.parse(s, DateTimeFormatter.ISO_DATE_TIME);
        } catch (DateTimeParseException ignored) { }

        // 2) Space-separated: 2025-12-12 10:30[:ss]
        try {
        ...
        // 3) Date-only: 2025-12-12 (assume start of day)
        try {
