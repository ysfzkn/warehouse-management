...
/**
 * Read-only catalog tools (safe by default).
 * These tools are intended for AI tool calling.
 */
@Component
public class CezeriCatalogTools {
    ...
    public CezeriCatalogTools(WarehouseService warehouseService,
