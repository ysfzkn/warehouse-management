package com.warehouse.cezeri.prompt;

import com.warehouse.cezeri.web.CezeriUiContext;
...
@Service
public class CezeriPromptService {

    private final ResourceLoader resourceLoader;

    public CezeriPromptService(ResourceLoader resourceLoader) {
        this.resourceLoader = resourceLoader;
    }

    public String buildSystemPrompt(String username, String role, CezeriUiContext ui) {
        String base = read("classpath:prompts/cezeri/system.md");
        String dev = read("classpath:prompts/cezeri/developer.md");
        String uiBlock = buildUiBlock(ui);

        String roleDisplay = CezeriRolePolicy.roleDisplayName(role);
    ...
    public String buildSystemPrompt(String username, String role, boolean allowMutations, CezeriUiContext ui) {
        ...
        return prompt + "\n" + mutationInstruction + "\n" + CezeriRolePolicy.policyBlockForRole(role) + "\n";
    }

    private String buildUiBlock(CezeriUiContext ui) {
        if (ui == null) {
