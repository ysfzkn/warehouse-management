package com.warehouse.cezeri.policy;

import java.util.Locale;

public final class CezeriRolePolicy {

    private CezeriRolePolicy() {}
...
""";
        ...
        // STOCK_IN vs STOCK_OUT: keep language user-friendly without exposing raw codes.
