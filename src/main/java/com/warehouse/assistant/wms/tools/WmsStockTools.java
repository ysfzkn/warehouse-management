...
/**
 * Read-only stock tools for the WMS assistant. Safe for tool calling.
 */
@Component
public class WmsStockTools {

    private final StockService stockService;
    private final StockRepository stockRepository;

    public WmsStockTools(StockService stockService, StockRepository stockRepository) {
